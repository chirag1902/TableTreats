  ...
  const features = [
    {
      ...
      desc: "Find the perfect restaurant with advanced filters, real reviews, and personalized recommendations based on your taste.",
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: "📅",
      title: "Instant Reservations",
      desc: "Book your table in seconds. See real-time availability and get instant confirmations—no phone calls needed.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: "🎁",
      title: "Exclusive Deals",
      desc: "Unlock special discounts and offers exclusive to Tabletreats users. Save money every time you dine out.",
      color: "from-orange-500 to-red-500",
    },
    {
      icon: "💳",
      title: "Seamless Payments",
      desc: "Pay your bill directly through the app. Split checks, add tips, and leave whenever you are ready.",
      color: "from-green-500 to-teal-500",
    },
    {
      icon: "⭐",
      title: "Authentic Reviews",
      desc: "Read honest reviews from verified diners. Share your own experiences and help others discover great spots.",
      color: "from-yellow-500 to-orange-500",
    },
    {
      icon: "🏆",
      title: "Loyalty Rewards",
      desc: "Earn points with every visit. Redeem rewards at your favorite restaurants and unlock VIP perks.",
  ...
  const steps = [
    {
      ...
      desc: "Browse restaurants near you, check menus and reviews, then reserve your table instantly.",
    },
    {
      num: "2",
      title: "Enjoy Your Meal",
      desc: "Show up and enjoy your dining experience. Your reservation and any deals are automatically applied.",
    },
    {
      num: "3",
      title: "Pay & Go",
      desc: "When you are done, simply pay through the app and leave. No waiting for the check.",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-8">
              ...
              <p className="text-xl text-white/90 leading-relaxed max-w-xl">
                Discover restaurants, reserve tables, unlock exclusive deals,
                and pay seamlessly—all in one place. Say goodbye to app juggling
                forever.
              </p>
                ...
                <div className="bg-white rounded-[42px] overflow-hidden">
                  ...
                  <div className="bg-gradient-to-b from-gray-50 to-white p-4 space-y-3 h-[600px] overflow-hidden">
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2">
                      {["Italian", "Japanese", "American", "Healthy"].map(
                        (cat, i) => (
                          <div
                            key={i}
                            className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full text-xs font-semibold whitespace-nowrap"
                          >
                            {cat}
                          </div>
                        )
                    ...
                    <div className="space-y-3">
                      {restaurants.map((restaurant, idx) => (
                        ...
                        >
                          <div
                            className={`h-32 bg-gradient-to-br ${restaurant.gradient} relative`}
                          >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Stop switching between apps. Tabletreats brings discovery,
              reservations, deals, and payments together.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, idx) => (
              ...
              >
                ...
                <div
                  className={`w-20 h-20 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center text-4xl mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all shadow-lg`}
                >
                  {feature.icon}
                </div>
      ...
      <section className="py-24 bg-gradient-to-br from-purple-600 via-pink-600 to-purple-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-2xl mb-10 text-white/90">
            Join thousands of diners who have simplified their restaurant
            experience
          </p>
          <button
            onClick={() => handleNavigate("/signup")}
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6">
                Your complete dine-in experience in one app. Discover, reserve,
                and enjoy!
              </p>
            </div>
            <div>
